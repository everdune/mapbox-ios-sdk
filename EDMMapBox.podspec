...
#  m.source = { :git => 'https://github.com/everdune/mapbox-ios-sdk.git', :tag => m.version.to_s }
  m.source = { :git => 'https://github.com/everdune/mapbox-ios-sdk.git', :branch => 'everdune-trackcourse' }
  ...
  m.xcconfig = { 'OTHER_LDFLAGS' => '-ObjC', 'LIBRARY_SEARCH_PATHS' => '"${PODS_ROOT}/EDMMapBox/Proj4"' }
